        ...
        parts: [
          {
            ...
            rating, descriptions. Suggest itinerary with placeName, Place Details, Place Image Url, Geo Coordinates, 
            ticket Pricing, rating, travel time for each of the location for 3 days, with best time to visit in JSON format.`,
          },
        ],
      },
    ],
